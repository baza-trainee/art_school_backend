...
def upgrade() -> None:
    ...
    op.alter_column('slider_main', 'title',
               existing_type=sa.VARCHAR(length=150),
               type_=sa.String(length=120),
               existing_nullable=True)
    op.alter_column('slider_main', 'description',
               existing_type=sa.VARCHAR(length=150),
...
def downgrade() -> None:
    ...
    op.alter_column('slider_main', 'title',
               ...
               type_=sa.VARCHAR(length=150),
               existing_nullable=True)
    op.add_column('posters', sa.Column('text', sa.VARCHAR(), autoincrement=False, nullable=True))
    # ### end Alembic commands ###
