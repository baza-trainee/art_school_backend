...
async def post_news(
    ...
    return await create_news(news_data, News, session)
...
async def partial_update_news(
    ...
    # await invalidate_cache("get_news_list")
    return await update_news(news_data, News, session, photo, news_id)
...
async def delete_news(
    ...
    # await invalidate_cache("get_news_list")
    # await invalidate_cache("get_news", news_id)
    return await delete_news_by_id(news_id, News, session)
